...
extra_length_size = 10; 

length_object = B21700_length_ES + 5;   //X
width_object = 45;    //Y
height_object = B21700_height_ES + extra_length_size;  //Z
    ...
    hull(){
        ...
        translate([0,-(width_parametric/2)+radius_circles_corner_parametric,-(height_parametric/2)+radius_circles_corner_parametric]){
            rotate([0,90,0]){
                ...
                rotate_array_battery_charger=[0,270,90];
    translate_array_battery_charger=[length_object-1,width_object/2,-height_object/2+0];
...
difference() {
    ...
    translate_array_switch=[length_object/2+SW_AL_tube_width_PT/2,width_object/2-(SW_AL_tube_width_PT/2)-10,-height_object/2+3];
